...
@Transactional
public class PostServiceImplTest extends AbstractTransactionalJUnit4SpringContextTests 
{
	@Autowired
	...
	public void testCreatePost() {
		String testMessage = "Message"+Math.random();
		String testUserName = "UserName"+Math.random();
		...
		assertEquals("Method returned wrong post", actualPost.getUserName(), testUserName);
	}
